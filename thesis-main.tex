...
\includecomment{poplForThesis}
\excludecomment{poplForPopl}
}{
\excludecomment{poplForThesis}
\includecomment{poplForPopl}
}
...
\includeonly{chap-intro-incr,popl18/formalization}
