...
APIs (or DSLs) contain powerful operators on collections such as \texttt{map}\pg{update
  style to be uniform with the one from lhs2TeX}, which are higher-order, that
