...
\begin{figure}[htb]
  ...
  \end{mathpar}
  \caption{The target language $\target$ (semantics of base terms and caches).}
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \infer[\rulename{TDClosureChange}]{
      \sectxlookup\tdectx{\tdf} = \tclosure{\tdectx_\tf}{\tlam{\tx\,\tdx\,\tcache}{\tdterm_\tf}} \\
      \matchcache
