...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \infer{
      \oldenvwithcache{\tectx}{\tcache}{\tectx'}
    }{
      \oldenvwithcache{\tectx}{\tcachecons\tcache\tx}{\tectx'}
    }

    \infer{
      \oldenvwithcache{\tectx}{\tcache}{\tectx'}
      \\
      \sneval{\oldenv\tectx}{\tlet{\ty, \tcacheid\ty\tf\tx = \tapp\tf\tx}{(\ty, \tcacheid\ty\tf\tx)}}{(\_, \tcachedclosedvalues)}
    }{
      \oldenvwithcache{\tectx}
