...
\newcommand\validfrom[3]{#3 \;\rhd\; #2 \mathrel{:}\> #1}
\newcommand\validfromto[4]{#3 \;\rhd\; #2 \hookrightarrow #4 \mathrel{:} #1}
\newcommand\validfromsyn[4]{#1 \models #4 \;\RHD\; #3 \mathrel{:}\> #2}
\newcommand\validfromtosyn[5]{#1 \models #4 \;\RHD\; #3 \hookrightarrow #5 \mathrel{:}\> #2}
\newcommand\validfromtosynunt[4]{#1 \models #3 \;\RHD\; #2 \hookrightarrow #4}
