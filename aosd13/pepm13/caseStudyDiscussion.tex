In this section we discuss the degree to which \LoS\ fulfilled our original design goals, and the conclusions
...
For instance, if type inference were extended with higher-order unification\footnote{\url{https://issues.scala-lang.org/browse/SI-2712}}~\citep{Pfenning88}, it would better support a part of our DSL interface (not discussed in this paper) by removing the need for type annotations.
