\newcommand{\graphPath}[1]{graphs/#1}
\input{graphs/evalRes}
\section{Evaluation}
...
%evaluation strategy
Throughout the paper, we have already shown several compact queries for which our optimizations increase performance significantly compared to a naive execution. Since some optimizations change 
...
\begin{figure}
	\centering
		\includegraphics[width=\linewidth]{graphs/measurements-overview}
