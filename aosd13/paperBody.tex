...
\chapter{Collection query embedding as a case study}
\label{sec:caseStudy}
...
discussed in Sec.~\ref{sec:solution}.
...
On the minus side, OptiQL supports fewer collections types (\texttt{ArrayList} and \texttt{HashMap}).
...
carry further overhead.
\pg{Resume and connect with \cref{sec:optim-vs-inc}.}
